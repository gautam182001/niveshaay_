...
jQuery(document).ready(function () {
  ...
  //     .find("blog-section .content")
  //     .slideToggle();
  //   $(this).closest(".content-wrap").toggleClass("open_content");
  //   $(" .content")
  //     .not($(this).closest(".content-wrap").find(" .content"))
  //     .slideUp();
  //   $(".content-wrap")
  ...
  $(".content").hide();
  $(".content-heading").click(function () {
    $(this).closest(".content-wrap").find(".content").slideToggle();
    $(this).closest(".content-wrap").toggleClass("open_content");
    $(".content")
      .not($(this).closest(".content-wrap").find(".content"))
      .slideUp();
  ...
  $(".financial-year-heading").click(function () {
    $(this)
      .closest(".financial-year-detail")
      .find(".financial-year-content")
      .slideToggle();
    ...
    $(".financial-year-detail")
      .not($(this).closest(".financial-year-detail"))
      .removeClass("open");
  });
